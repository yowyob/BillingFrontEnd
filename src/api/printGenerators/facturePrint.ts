// Mirrors quotationPrint.ts's exact A4 layout/CSS, adapted for FactureResponse
// (invoice) fields instead of Devis fields.
        ...
        <footer class="footer">
            <div class="terms">
                ...
                <div class="terms-content">
                    ...
                    <p class="terms-text">Payment is due by the date specified above. Please reference the invoice number in your payment.</p>
                </div>
            </div>
